...
let NotificationServiceController = class NotificationServiceController {
    ...
    async handlePostCreated(data) {
        console.log(`Notification Service: Received post_created event for user ${data.userId}. Caption: ${data.caption}`);
    }
};
...
], NotificationServiceController.prototype, "handlePostCreated", null);
exports.NotificationServiceController = NotificationServiceController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [notification_service_service_1.NotificationServiceService])
], NotificationServiceController);
//# sourceMappingURL=notification-service.controller.js.map